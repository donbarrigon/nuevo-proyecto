...
type StoreUser struct {
	...
	Nickname             string         `json:"nickname"                   rules:"required|username|max:255|unique:users,profile.nickname"`
...
func (v *StoreUser) PrepareForValidation(ctx *app.HttpContext) app.Error { return nil }
