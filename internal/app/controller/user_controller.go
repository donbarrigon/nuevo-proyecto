...
func NewUserController(w http.ResponseWriter, r *http.Request) *UserController {
...
// func (u *UserController) Update(ctx *Context) {
...
// func (u *UserController) Destroy(ctx *Context) {
...
// func (u *UserController) Login(ctx *Context) {
...
// func (u *UserController) Logout(ctx *Context) {
